...
$(document).ready(function(){
    ...
    if ($("#curved-line-chart")[0]) {
        $.plot($("#curved-line-chart"), [
            {data: d1, lines: { show: true, fill: 0.98 }, label: 'Jobs Near You', stack: true, color: '#e3e3e3' },
            {data: d3, lines: { show: true, fill: 0.98 }, label: 'Jobs Applied Your For', stack: true, color: '#f1dd2c' }
        ], options);
    }
